...
export default function Hero() {
  ...
  useGSAP(() => {
    ...
    // 50% -> 75%: Bezel UI markings fade in
    ...
    // 70% -> 90%: Headline, subtitle and details begin appearing (curtains are mostly open)
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-[3vw] top-[15vh] bottom-[15vh] w-[2px] bg-gradient-to-b from-transparent via-[#facc15]/15 to-transparent opacity-60 z-0" />
      <div className="absolute right-[3vw] top-[15vh] bottom-[15vh] w-[2px] bg-gradient-to-b from-transparent via-[#facc15]/15 to-transparent opacity-60 z-0" />

      {/* Ambient background glow */}
      <div className="absolute w-[60vw] h-[60vw] bg-[#facc15]/5 rounded-full pointer-events-none z-0" />
      ...
      <div className="relative p-[6px] rounded-[3.2rem] bg-gradient-to-b from-[#1b1c20] via-[#090a0c] to-[#030304] shadow-[0_30px_100px_rgba(0,0,0,0.85)] border border-white/5 z-10 flex items-center justify-center">
        ...
        <div 
          ref={topLabelRef}
          className="absolute -top-[2.2rem] left-[1.5rem] select-none pointer-events-none font-mono text-[9px] tracking-[0.35em] text-white/35 uppercase z-30"
        >
        ...
        <div 
          ref={topStatusRef}
          className="absolute -top-[2.2rem] right-[1.5rem] select-none pointer-events-none font-mono text-[9px] tracking-[0.35em] text-white/35 uppercase flex gap-6 z-30"
        >
        ...
        >
          ...
          <div ref={reflectionsRef} className="absolute inset-0 pointer-events-none" style={{ zIndex: 28 }}>
            ...
            <div 
              className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-br from-cyan-500/10 via-white/10 to-transparent"
            />
